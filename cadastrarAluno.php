...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark" id="menu">
        <div class="collapse navbar-collapse" id="navbarColor01">
            <h2 style="font-family: 'Libre Baskerville';"><a id="link">Cadastrar aluno</a></h2>
        </div>
    </nav>
    <br><br><br>
        ...
        <div class="container">
            ...
            <div class="box2">
                <div style="margin-left: 15px; margin-top: 4px">
                    <input type="text" name="aluno" id="aluno" size="65" style="height: 35px" required>
                </div>
                ...
                <div style="margin: 15px; margin-top: 20px;">
                    <input type="date" name="data" id="data" style="height: 35px; width: 255px" required>
                </div>
                <div style="margin: 15px; margin-top: 15px;">
                    <input type="text" name="telefone" id="telefone" size="31" style="height: 35px" required>
                </div>
            </div>
        </div>
